# Support Astronomer build configuration file, created by
# `ablog start` on Fri Dec 25 09:46:12 2020.
#
# Note that not all possible configuration values are
# present in this file.  All configuration values have a
...
htmlhelp_basename = 'SupportAstronomerdoc'
...
blog_title = u'Support Astronomer Blog'
...
ablog_website = '_build/docs'
ablog_doctrees = '_build'
...
blog_authors = {
    author.split()[0]: (author, None),
}

blog_default_author = author.split()[0]
...
# Default is ``{}``.
blog_languages = {'en': ('English', None), 'ca': ('Catal\u00E0', None)}
